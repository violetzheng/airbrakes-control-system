...
MODEL                   = ver1_3DOF_draft2
MODULES                 = rtGetInf.c rtGetNaN.c rt_nonfinite.c ver1_3DOF_draft2.c ver1_3DOF_draft2_capi.c ver1_3DOF_draft2_data.c ver1_3DOF_draft2_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = ver1_3DOF_draft2
MAKEFILE                = ver1_3DOF_draft2.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023b.app
START_DIR               = /Users/User/Documents/airbrakes_ares/airbrakes
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 11
COMPUTER                = MACA64
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="/Applications/MATLAB_R2023b.app" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=1" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=11.0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB_R2023b.app/bin/maca64 -Wl,-rpath,/Applications/MATLAB_R2023b.app/sys/os/maca64 -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB_R2023b.app/sys/os/maca64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/ver1_3DOF_draft2 \
